'''
The file generates MHK networks for LTM, make sure to ajust the generation function when other networks needed.
'''
...
probabilities = np.append([0], np.linspace(0.9,1,100))
# probabilities = [0]
...
for n in N:
    for k in K:
        ...
        for prob in probabilities:
            ...
            print('\r' + f'Generated graph with p: {prob:.2f}\tID: {G.gp.ID}.gt', end='', flush=True)
